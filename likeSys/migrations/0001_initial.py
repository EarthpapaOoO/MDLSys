# Generated by Django 4.2.11 on 2025-04-23 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=likeSys.models.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fact_choice', models.BooleanField()),
                ('style_choice', models.BooleanField()),
                ('background_choice', models.BooleanField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='likeSys.document')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='likeSys.customuser')),
            ],
            options={
